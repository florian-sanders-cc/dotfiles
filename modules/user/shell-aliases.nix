...
in
{
  ...
  proAliases = {
    ...
    upd-pro = "nix flake update --flake '${nixosConfigPath}'; run0 nixos-rebuild boot --flake '${nixosConfigPath}#pro'";
    rebuild-pro = "run0 nixos-rebuild boot --flake '${nixosConfigPath}#pro'";
    ccprod = "clever profile switch -a prod";
    ccdev = "clever profile switch -a dev";
  };
  persoAliases = {
    upd-perso = "nix flake update --flake '${nixosConfigPath}'; run0 nixos-rebuild boot --flake '${nixosConfigPath}#perso'";
    rebuild-perso = "run0 nixos-rebuild boot --flake '${nixosConfigPath}#perso'";
  };
  persoWorkstationAliases = {
    upd-perso-workstation = "nix flake update --flake '${nixosConfigPath}'; run0 nixos-rebuild boot --flake '${nixosConfigPath}#perso-workstation'";
    rebuild-perso-workstation = "run0 nixos-rebuild boot --flake '${nixosConfigPath}#perso-workstation'";
  };
  commonAliases = {
    ll = "ls -l -a";
