...
vim.keymap.set({ "n" }, "<leader>oI", "<cmd>Octo issue search<cr>", { desc = "Search Issues" })
vim.keymap.set({ "n" }, "<leader>op", "<cmd>Octo pr list<cr>", { desc = "List PRs" })
vim.keymap.set({ "n" }, "<leader>oP", "<cmd>Octo pr search<cr>", { desc = "Search PRs" })
vim.keymap.set({ "n" }, "<leader>or", "<cmd>Octo repo list<cr>", { desc = "List Repos" })
vim.keymap.set({ "n" }, "<leader>oS", "<cmd>Octo search<cr>", { desc = "Search" })
...
vim.keymap.set({ "n", "v" }, "<leader>oa", "<cmd>Octo actions<cr>", { desc = "List Octo actions" })
